...
| `query-endpoint` | BC-2 (aplica a regra de autoridade e confiança) + BC-1 (contrato de saída: fonte, confiança, selos) | "Este módulo é o ponto de tradução entre BC-2 e BC-1 — a regra de cálculo de confiança vem do BC-2; o formato de exibição obedece ao contrato do BC-1." |
